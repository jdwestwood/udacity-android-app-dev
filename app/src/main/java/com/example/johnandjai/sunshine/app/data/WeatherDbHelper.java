...
import com.example.johnandjai.sunshine.app.data.WeatherContract.LocationEntry;
...
public class WeatherDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        // Create the table to hold weather data using raw SQL.
        ...
        final String SQL_CREATE_LOCATION_TABLE =
                "CREATE TABLE " + LocationEntry.TABLE_NAME + " (" +
                        ...
                        // An attempt to write an entry with the same location setting as one that
                        // already exists will be ignored
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int i, int i2) {
        // since no user-generated data is in our tables, just delete them and create new
        // ones having the latest version of SQLite.
